  ...
  if (id === "whatsapp") {
    return (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M12.04 3.5a8.45 8.45 0 0 0-7.25 12.82l-.86 3.18 3.26-.85a8.45 8.45 0 1 0 4.85-15.15Z" />
        <path d="M8.9 8.1c.2-.45.42-.46.62-.46h.52c.17 0 .4.06.61.48.22.52.76 1.8.82 1.94.06.13.1.3.02.48-.1.2-.16.31-.31.48-.16.18-.33.4-.47.54-.15.15-.31.31-.13.62.18.3.8 1.32 1.73 2.14 1.2 1.06 2.18 1.38 2.5 1.54.31.16.5.13.68-.08.2-.22.79-.92 1-1.24.2-.31.42-.26.7-.16.3.1 1.86.88 2.18 1.04.31.16.52.24.6.37.07.13.07.76-.18 1.5-.26.73-1.5 1.4-2.08 1.45-.54.05-1.23.07-1.98-.13-.46-.12-1.05-.34-1.8-.67-3.17-1.37-5.25-4.56-5.4-4.77-.16-.21-1.29-1.72-1.29-3.28 0-1.56.82-2.33 1.11-2.65Z" />
      </svg>
    );
  }
