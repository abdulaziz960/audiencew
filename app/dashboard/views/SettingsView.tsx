  ...
  if (id === "whatsapp") {
    return (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M12 3.3a8.5 8.5 0 0 0-7.28 12.9L3.85 20l3.9-1.02A8.5 8.5 0 1 0 12 3.3Z" />
        <path d="M8.65 8.03c.2-.43.42-.44.6-.44h.5c.16 0 .38.06.58.46.21.5.72 1.72.78 1.85.06.12.1.3.02.46-.08.18-.14.29-.3.45-.14.17-.3.37-.44.51-.15.15-.3.3-.12.58.17.3.76 1.24 1.62 2 .94.83 1.75 1.14 2.05 1.29.3.15.47.12.64-.08.2-.21.75-.87.95-1.17.2-.3.4-.25.67-.15.28.1 1.78.84 2.08.99.3.15.5.22.57.35.07.13.07.72-.17 1.42-.24.7-1.37 1.33-1.93 1.38-.5.04-1.15.06-1.86-.12-.43-.12-.98-.32-1.7-.63-2.97-1.29-4.9-4.25-5.05-4.45-.15-.2-1.2-1.6-1.2-3.06 0-1.46.76-2.17 1.04-2.47Z" />
      </svg>
    );
  }
